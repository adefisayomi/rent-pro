...
export const SocialAuth = () => {
    ...
    return (
        <div className="w-full grid grid-cols-2 gap-4">
            <Button onClick={() => handleAuth(facebookLogin)} variant='outline' className="flex items-center justify-center gap-1 text-muted-foreground">
                <Facebook className="text-blue-600"/> 
                Facebook
            </Button>

            <Button onClick={() => handleAuth(googleLogin)} variant='outline' className="flex items-center justify-center gap-1 text-muted-foreground">
