    ...
    <div className="w-full bg-slate-900">
      <div className="w-full max-w-8xl mx-auto flex flex-col items-center md:gap-4 md:flex-row md:justify-normal justify-center px-4 py-8 md:py-32">
        <div className="flex flex-col items-center gap-1 max-w-lg">
          ...
          <div className="grid items-center gap-4 mt-6 md:mt-0 md:grid-cols-4">
...
const ServiceComponent = ({ details, icon, title }: Service) => {
  return (
    <div className=" flex border aspect-square md:aspect-auto border-muted-foreground h-full cursor-pointer items-center flex-col gap-4 w-full max-w-[250px] hover:bg-slate-900 duration-300 hover:scale-105 rounded-xl p-4">
