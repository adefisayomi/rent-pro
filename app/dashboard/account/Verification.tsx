...
export default function Verification ({title, userScore}: {title: string, userScore: any}) {
...
export const TrustScore = ({userScore}: {userScore: any}) => {
    ...
    const _testScoreTags = {
        ...
        "profile completion": {lebel: 'profile completion', level: userScore?.completion || 0},
